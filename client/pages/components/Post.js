    ...
    return (
        <article className="relative top-0 rounded-md right-30 pt-5 w-3/5 mt-12 bg-gray-700 text-gray-300 max-w-7xl">
            ...
            <div className="flex justify-between mt-5">
                ...
                <button 
                onClick={handleLike}
                className={hasLiked ? "flex items-center hover:bg-gray-500 p-4 justify-center text-green-600 w-1/3" 
                :
                "flex items-center justify-center p-4  w-1/3 hover:bg-gray-500"}>
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5"></path>
                    </svg>
                </button>
                {/* Comment button */}
                <button onClick={handleFocus} className="flex items-center p-4 justify-center w-1/3 hover:bg-gray-500">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"></path>
                    </svg>
                </button>
                {/* Share button */}
                <button className="flex items-center justify-center  p-4 w-1/3  hover:bg-gray-500">
                    <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
